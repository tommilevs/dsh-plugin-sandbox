...
function SandboxPanel() {
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('div', { style: { border: '1px solid var(--dsw-alias-border-subtle, #444)', borderRadius: 12, padding: 12, marginBottom: 14 } },
      React.createElement('div', { style: { fontWeight: 650 } }, 'Plugin updates'),
      ...
      React.createElement('div', { style: buttonRow },
        React.createElement(Button, { onClick: checkForUpdates, disabled: releaseStatus?.state === 'checking' }, releaseStatus?.state === 'checking' ? 'Checking…' : 'Check for updates'),
        releaseStatus?.state === 'update-available' && React.createElement(Button, { onClick: updateRelease }, `Update to v${releaseStatus.release.version}`),
